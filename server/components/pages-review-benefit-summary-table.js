exports.ids = [17];
exports.modules = Array(71).concat([
/* 71 */
...
/* harmony import */ var _src_directives_ripple_VRipple_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(91);
...
/* harmony import */ var _util_helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
// Styles
 // Utilities
...
"use strict";
/* harmony import */ var _src_components_VSheet_VSheet_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(93);
...
/* harmony import */ var _mixins_binds_attrs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(77);
/* harmony import */ var _mixins_colorable__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(73);
/* harmony import */ var _mixins_elevatable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(85);
/* harmony import */ var _mixins_measurable__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(86);
/* harmony import */ var _mixins_roundable__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(81);
/* harmony import */ var _mixins_themeable__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(72);
/* harmony import */ var _util_mixins__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(71);
// Styles
 // Mixins
...
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(vue__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _directives_ripple__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(74);
/* harmony import */ var _util_helpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
 // Directives
...
var mergeData = __webpack_require__(75);
...
"use strict";
/* harmony import */ var _VSheet__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(76);
...
var transitions = __webpack_require__(82);

// EXTERNAL MODULE: ./node_modules/vuetify/lib/directives/intersect/index.js
var intersect = __webpack_require__(79);

// EXTERNAL MODULE: ./node_modules/vuetify/lib/mixins/colorable/index.js
var colorable = __webpack_require__(73);

// EXTERNAL MODULE: ./node_modules/vuetify/lib/mixins/positionable/index.js
var positionable = __webpack_require__(78);

// EXTERNAL MODULE: ./node_modules/vuetify/lib/mixins/proxyable/index.js
var proxyable = __webpack_require__(83);

// EXTERNAL MODULE: ./node_modules/vuetify/lib/mixins/themeable/index.js
var themeable = __webpack_require__(72);

// EXTERNAL MODULE: ./node_modules/vuetify/lib/util/helpers.js
var helpers = __webpack_require__(3);

// EXTERNAL MODULE: ./node_modules/vuetify/lib/util/mixins.js
var mixins = __webpack_require__(71);
...
module.exports.__inject__ = function (context) {
  add("acd99ea2", content, true, context)
};
...
var VDataTable = __webpack_require__(110);
...
/* harmony default export */ var VData = (external_vue_default.a.extend({
  ...
  data() {
    let internalOptions = {
      ...
      sortBy: Object(helpers["C" /* wrapInArray */])(this.sortBy),
      sortDesc: Object(helpers["C" /* wrapInArray */])(this.sortDesc),
      groupBy: Object(helpers["C" /* wrapInArray */])(this.groupBy),
      groupDesc: Object(helpers["C" /* wrapInArray */])(this.groupDesc),
    ...
    if (sortDiff > 0) {
      internalOptions.sortDesc.push(...Object(helpers["j" /* fillArray */])(sortDiff, false));
    }

    if (groupDiff > 0) {
      internalOptions.groupDesc.push(...Object(helpers["j" /* fillArray */])(groupDiff, false));
    }
  ...
  watch: {
    computedOptions: {
      handler(options, old) {
        if (Object(helpers["g" /* deepEqual */])(options, old)) return;
    ...
    sortBy(sortBy) {
      this.updateOptions({
        sortBy: Object(helpers["C" /* wrapInArray */])(sortBy)
      });
    },

    'internalOptions.sortBy'(sortBy, old) {
      !Object(helpers["g" /* deepEqual */])(sortBy, old) && this.$emit('update:sort-by', Array.isArray(this.sortBy) ? sortBy : sortBy[0]);
    },

    sortDesc(sortDesc) {
      this.updateOptions({
        sortDesc: Object(helpers["C" /* wrapInArray */])(sortDesc)
      });
    },

    'internalOptions.sortDesc'(sortDesc, old) {
      !Object(helpers["g" /* deepEqual */])(sortDesc, old) && this.$emit('update:sort-desc', Array.isArray(this.sortDesc) ? sortDesc : sortDesc[0]);
    },

    groupBy(groupBy) {
      this.updateOptions({
        groupBy: Object(helpers["C" /* wrapInArray */])(groupBy)
      });
    },

    'internalOptions.groupBy'(groupBy, old) {
      !Object(helpers["g" /* deepEqual */])(groupBy, old) && this.$emit('update:group-by', Array.isArray(this.groupBy) ? groupBy : groupBy[0]);
    },

    groupDesc(groupDesc) {
      this.updateOptions({
        groupDesc: Object(helpers["C" /* wrapInArray */])(groupDesc)
      });
    },

    'internalOptions.groupDesc'(groupDesc, old) {
      !Object(helpers["g" /* deepEqual */])(groupDesc, old) && this.$emit('update:group-desc', Array.isArray(this.groupDesc) ? groupDesc : groupDesc[0]);
    },
    ...
    pagination: {
      handler(pagination, old) {
        if (Object(helpers["g" /* deepEqual */])(pagination, old)) return;
  ...
  methods: {
    toggle(key, oldBy, oldDesc, page, mustSort, multiSort) {
      ...
      if (!Object(helpers["g" /* deepEqual */])(by, oldBy) || !Object(helpers["g" /* deepEqual */])(desc, oldDesc)) {
        page = 1;
      }
...
var VDataFooter = __webpack_require__(112);

// EXTERNAL MODULE: external "core-js/modules/esnext.array.last-item.js"
var esnext_array_last_item_js_ = __webpack_require__(54);

// EXTERNAL MODULE: external "core-js/modules/esnext.map.delete-all.js"
var esnext_map_delete_all_js_ = __webpack_require__(55);

// EXTERNAL MODULE: external "core-js/modules/esnext.map.every.js"
var esnext_map_every_js_ = __webpack_require__(56);

// EXTERNAL MODULE: external "core-js/modules/esnext.map.filter.js"
var esnext_map_filter_js_ = __webpack_require__(57);

// EXTERNAL MODULE: external "core-js/modules/esnext.map.find.js"
var esnext_map_find_js_ = __webpack_require__(58);

// EXTERNAL MODULE: external "core-js/modules/esnext.map.find-key.js"
var esnext_map_find_key_js_ = __webpack_require__(59);

// EXTERNAL MODULE: external "core-js/modules/esnext.map.includes.js"
var esnext_map_includes_js_ = __webpack_require__(60);

// EXTERNAL MODULE: external "core-js/modules/esnext.map.key-of.js"
var esnext_map_key_of_js_ = __webpack_require__(61);

// EXTERNAL MODULE: external "core-js/modules/esnext.map.map-keys.js"
var esnext_map_map_keys_js_ = __webpack_require__(62);

// EXTERNAL MODULE: external "core-js/modules/esnext.map.map-values.js"
var esnext_map_map_values_js_ = __webpack_require__(63);

// EXTERNAL MODULE: external "core-js/modules/esnext.map.merge.js"
var esnext_map_merge_js_ = __webpack_require__(64);

// EXTERNAL MODULE: external "core-js/modules/esnext.map.reduce.js"
var esnext_map_reduce_js_ = __webpack_require__(65);

// EXTERNAL MODULE: external "core-js/modules/esnext.map.some.js"
var esnext_map_some_js_ = __webpack_require__(66);

// EXTERNAL MODULE: external "core-js/modules/esnext.map.update.js"
var esnext_map_update_js_ = __webpack_require__(67);

// EXTERNAL MODULE: ./node_modules/vuetify/src/components/VTextField/VTextField.sass
var VTextField = __webpack_require__(99);

// EXTERNAL MODULE: ./node_modules/vuetify/src/components/VSelect/VSelect.sass
var VSelect = __webpack_require__(115);
...
var binds_attrs = __webpack_require__(77);
...
/* @vue/component */
  ...
  methods: {
    getIcon() {
      ...
      return Object(helpers["y" /* remapInternalIcon */])(this, iconName);
    },
    ...
    getSize() {
      ...
      const explicitSize = Object(helpers["v" /* keys */])(sizes).find(key => sizes[key]);
...
/* harmony default export */ var VChip_VChip = (Object(mixins["a" /* default */])(colorable["a" /* default */], sizeable, routable["a" /* default */], themeable["a" /* default */], factory('chipGroup'), toggleable_factory('inputValue')).extend({
  name: 'v-chip',
  props: {
    active: {
      type: Boolean,
...
var VMenu = __webpack_require__(147);
...
const baseMixins = Object(mixins["a" /* default */])(delayable, toggleable);
/* @vue/component */
...
/* harmony default export */ var activatable = (baseMixins.extend({
  ...
  mounted() {
    const slotType = Object(helpers["q" /* getSlotType */])(this, 'activator', true);
  ...
  methods: {
    ...
    genActivator() {
      const node = Object(helpers["p" /* getSlot */])(this, 'activator', Object.assign(this.getValueProxy(), {
    ...
    getContentSlot() {
      return Object(helpers["p" /* getSlot */])(this, 'default', this.getValueProxy(), true);
    },
...
/* harmony default export */ var stackable = (external_vue_default.a.extend().extend({
  ...
  computed: {
    activeZIndex() {
      ...
      const index = !this.isActive ? Object(helpers["r" /* getZIndex */])(content) : this.getMaxZIndex(this.stackExclude || [content]) + 2;
  ...
  methods: {
    getMaxZIndex(exclude = []) {
      ...
      const zis = [this.stackMinZIndex, Object(helpers["r" /* getZIndex */])(base)]; // Convert the NodeList to an array to
      ...
      for (let index = 0; index < activeElements.length; index++) {
        if (!exclude.includes(activeElements[index])) {
          zis.push(Object(helpers["r" /* getZIndex */])(activeElements[index]));
        }
      }
...
var roundable = __webpack_require__(81);
...
var VSimpleCheckbox = __webpack_require__(129);

// EXTERNAL MODULE: ./node_modules/vuetify/lib/directives/ripple/index.js
var directives_ripple = __webpack_require__(74);
      ...
      on: {
        click: e => {
          ...
          if (data.on && data.on.input && !props.disabled) {
            Object(helpers["C" /* wrapInArray */])(data.on.input).forEach(f => f(!props.value));
          }
        }
      }
    }), [h('div', {
...
var VDivider = __webpack_require__(131);
...
var VSubheader = __webpack_require__(133);
...
var VListItem = __webpack_require__(127);
...
const VListItem_baseMixins = Object(mixins["a" /* default */])(colorable["a" /* default */], routable["a" /* default */], themeable["a" /* default */], factory('listItemGroup'), toggleable_factory('inputValue'));
/* @vue/component */
...
var VList = __webpack_require__(135);
...
var VListGroup = __webpack_require__(137);
...
const VListGroup_baseMixins = Object(mixins["a" /* default */])(binds_attrs["a" /* default */], bootable, colorable["a" /* default */], inject('list'), toggleable);
...
var VListItemGroup = __webpack_require__(141);

// EXTERNAL MODULE: ./node_modules/vuetify/src/components/VItemGroup/VItemGroup.sass
var VItemGroup = __webpack_require__(143);
...
var VAvatar = __webpack_require__(139);

// EXTERNAL MODULE: ./node_modules/vuetify/lib/mixins/measurable/index.js
var measurable = __webpack_require__(86);
...
var VInput = __webpack_require__(117);
...
var VMessages = __webpack_require__(123);
...
var VCounter = __webpack_require__(125);
...
var loadable = __webpack_require__(87);
...
/* harmony default export */ var VSelect_VSelect = (VSelect_baseMixins.extend().extend({
  ...
  methods: {
    ...
    onKeyDown(e) {
      if (this.isReadonly && e.keyCode !== helpers["u" /* keyCodes */].tab) return;
      ...
      if (this.isMenuActive && [helpers["u" /* keyCodes */].up, helpers["u" /* keyCodes */].down, helpers["u" /* keyCodes */].home, helpers["u" /* keyCodes */].end, helpers["u" /* keyCodes */].enter].includes(keyCode)) {
        this.$nextTick(() => {
      ...
      if ([helpers["u" /* keyCodes */].enter, helpers["u" /* keyCodes */].space].includes(keyCode)) this.activateMenu(); // If menu is not active, up/down/home/end can do
      // one of 2 things. If multiple, opens the
      // menu, if not, will cycle through all
      // available options

      if (!this.isMenuActive && [helpers["u" /* keyCodes */].up, helpers["u" /* keyCodes */].down, helpers["u" /* keyCodes */].home, helpers["u" /* keyCodes */].end].includes(keyCode)) return this.onUpDown(e); // If escape deactivate the menu
    ...
    onUpDown(e) {
      ...
      window.requestAnimationFrame(() => {
        ...
        switch (keyCode) {
          case helpers["u" /* keyCodes */].up:
            menu.prevTile();
            break;

          case helpers["u" /* keyCodes */].down:
            menu.nextTile();
            break;

          case helpers["u" /* keyCodes */].home:
            menu.firstTile();
            break;

          case helpers["u" /* keyCodes */].end:
            menu.lastTile();
            break;
        }
...
var elevatable = __webpack_require__(85);
...
const VBtn_baseMixins = Object(mixins["a" /* default */])(components_VSheet["a" /* default */], routable["a" /* default */], positionable["a" /* default */], sizeable, factory('btnToggle'), toggleable_factory('inputValue')
/* @vue/component */
);
...
/* harmony default export */ var VDataIterator_VDataFooter = (external_vue_default.a.extend({
  ...
  render() {
    ...
    }, [Object(helpers["p" /* getSlot */])(this, 'prepend'), this.genItemsPerPageSelect(), this.genPaginationInfo(), this.genIcons()]);
  }
...
/* harmony default export */ var VDataIterator = (Object(mixins["a" /* default */])(mobile, themeable["a" /* default */]).extend({
  ...
  watch: {
    ...
    selection(value, old) {
      if (Object(helpers["g" /* deepEqual */])(Object.keys(value), Object.keys(old))) return;
    ...
    expansion(value, old) {
      if (Object(helpers["g" /* deepEqual */])(value, old)) return;
  ...
  methods: {
    onKeyDown(e) {
      if (e.keyCode !== helpers["u" /* keyCodes */].shift) return;
    ...
    isSelectable(item) {
      return Object(helpers["m" /* getObjectValueByPath */])(item, this.selectableKey) !== false;
    },
    ...
    select(item, value = true, emit = true) {
      ...
      const key = Object(helpers["m" /* getObjectValueByPath */])(item, this.itemKey);
      if (value) selection[key] = item;else delete selection[key];
      const index = this.selectableItems.findIndex(x => Object(helpers["m" /* getObjectValueByPath */])(x, this.itemKey) === key);
      if (this.lastEntry === -1) this.lastEntry = index;else if (this.shiftKeyDown && !this.singleSelect && emit) {
        const lastEntryKey = Object(helpers["m" /* getObjectValueByPath */])(this.selectableItems[this.lastEntry], this.itemKey);
      ...
      if (this.singleSelect && emit) {
        ...
        const old = keys.length && Object(helpers["m" /* getObjectValueByPath */])(this.selection[keys[0]], this.itemKey);
    ...
    multipleSelect(value = true, emit = true, selection, index) {
      ...
      for (let i = start; i <= end; i++) {
        ...
        const key = Object(helpers["m" /* getObjectValueByPath */])(currentItem, this.itemKey);
  ...
  render() {
    return this.$createElement(VData, {
      props: this.$props,
      on: {
        'update:options': (v, old) => !Object(helpers["g" /* deepEqual */])(v, old) && this.$emit('update:options', v),
        ...
        pagination: (v, old) => !Object(helpers["g" /* deepEqual */])(v, old) && this.$emit('pagination', v),
        'current-items': v => {
...
var VDataTableHeader = __webpack_require__(153);
...
/* harmony default export */ var VDataTableHeaderMobile = (Object(mixins["a" /* default */])(mixins_header).extend({
  ...
  render(h) {
    ...
    if (header && !this.singleSelect) {
      children.push(this.$createElement('div', {
        class: ['v-data-table-header-mobile__select', ...Object(helpers["C" /* wrapInArray */])(header.class)],
        attrs: {
          width: header.width
        }
      }, [this.genSelectAll()]));
  ...
  methods: {
    ...
    genHeader(header) {
      const data = {
        ...
        class: [`text-${header.align || 'start'}`, ...Object(helpers["C" /* wrapInArray */])(header.class), header.divider && 'v-data-table__divider'],
        on: {}
      };
      const children = [];
...
/* harmony default export */ var Row = (external_vue_default.a.extend({
  ...
  render(h, {
    ...
    const columns = props.headers.map(header => {
      ...
      if (scopedSlot) {
        children.push(...Object(helpers["C" /* wrapInArray */])(scopedSlot({
          item: props.item,
          isMobile: false,
          header,
          index: props.index,
        ...
        children.push(...Object(helpers["C" /* wrapInArray */])(regularSlot));
      } else {
...
function searchTableItems(items, search, headersWithCustomFilters, headersWithoutCustomFilters, customFilter) {
  ...
  return items.filter(item => {
    ...
    const matchesColumnFilters = headersWithCustomFilters.every(filterFn(item, search, helpers["h" /* defaultFilter */])); // Headers without custom filters are only filtered by the `search` property if it is defined.
...
/* harmony default export */ var VDataTable_VDataTable = __webpack_exports__["a"] = (Object(mixins["a" /* default */])(VDataIterator, loadable["a" /* default */]).extend({
  ...
  props: {
    ...
    customFilter: {
      type: Function,
      default: helpers["h" /* defaultFilter */]
    },
    itemClass: {
  ...
  methods: {
    ...
    genDefaultSimpleRow(item, index, classes = {}) {
      ...
      return this.$createElement(this.isMobile ? MobileRow : Row, {
        ...
        }, Object(helpers["o" /* getPropertyFromItem */])(item, this.itemClass)),
        props: {
          headers: this.computedHeaders,
    ...
    genFooters(props) {
      ...
      if (!this.hideDefaultFooter) {
        children.push(this.$createElement(VDataIterator_VDataFooter, { ...data,
          scopedSlots: Object(helpers["n" /* getPrefixedScopedSlots */])('footer.', this.$scopedSlots)
        }));
      }
    ...
    genDefaultScopedSlot(props) {
      ...
      }, [this.proxySlot('top', Object(helpers["p" /* getSlot */])(this, 'top', { ...props,
        isMobile: this.isMobile
    ...
    return this.$createElement(VData, {
      ...
      on: {
        'update:options': (v, old) => {
          ...
          !Object(helpers["g" /* deepEqual */])(v, old) && this.$emit('update:options', v);
        },
        'update:page': v => this.$emit('update:page', v),
        'update:items-per-page': v => this.$emit('update:items-per-page', v),
        'update:sort-by': v => this.$emit('update:sort-by', v),
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_BenefitSummaryTable_vue_vue_type_style_index_0_id_479044a9_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(184);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_BenefitSummaryTable_vue_vue_type_style_index_0_id_479044a9_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_BenefitSummaryTable_vue_vue_type_style_index_0_id_479044a9_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_BenefitSummaryTable_vue_vue_type_style_index_0_id_479044a9_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_BenefitSummaryTable_vue_vue_type_style_index_0_id_479044a9_prod_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".table thead th[data-v-479044a9],.text-start[data-v-479044a9]{white-space:nowrap!important}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/pages/Review/BenefitSummary/BenefitSummaryTable.vue?vue&type=template&id=479044a9&scoped=true&
...
// CONCATENATED MODULE: ./components/pages/Review/BenefitSummary/BenefitSummaryTable.vue?vue&type=template&id=479044a9&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/pages/Review/BenefitSummary/BenefitSummaryTable.vue?vue&type=script&lang=js&


/* harmony default export */ var BenefitSummaryTablevue_type_script_lang_js_ = ({
  ...
  methods: {
    computeDataSet() {
      ...
      const res = Array(7).fill(0).reduce((acc, cur, index) => {
        return [...acc, {
...
// CONCATENATED MODULE: ./components/pages/Review/BenefitSummary/BenefitSummaryTable.vue?vue&type=script&lang=js&
 /* harmony default export */ var BenefitSummary_BenefitSummaryTablevue_type_script_lang_js_ = (BenefitSummaryTablevue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(11);

// EXTERNAL MODULE: ./node_modules/vuetify-loader/lib/runtime/installComponents.js
var installComponents = __webpack_require__(88);
var installComponents_default = /*#__PURE__*/__webpack_require__.n(installComponents);

// EXTERNAL MODULE: ./node_modules/vuetify/lib/components/VDataTable/VDataTable.js + 71 modules
var VDataTable = __webpack_require__(192);

// CONCATENATED MODULE: ./components/pages/Review/BenefitSummary/BenefitSummaryTable.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  BenefitSummary_BenefitSummaryTablevue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var BenefitSummaryTable = __webpack_exports__["default"] = (component.exports);

/* vuetify-loader */


installComponents_default()(component, {VDataTable: VDataTable["a" /* default */]})


/***/ })
]);;
//# sourceMappingURL=pages-review-benefit-summary-table.js.map